...
namespace System
{
    ...
    public static partial class ExtensionsDateTime
    {
        ...
        persianToMiladiDateTime (this string date,
                                 Char dateSeparator = '/',
                                 Char timeSeparator = ':')
        {
            DateTime result = new DateTime();
            ...
            string[] dateVal = (val.Length > 0 ? val[0].Split(dateSeparator, '-') : null);
            string[] timeVal = (val.Length > 1 ? val[1].Split(timeSeparator, ':') : null);
