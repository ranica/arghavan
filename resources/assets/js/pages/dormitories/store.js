...
const getters = {
     ...
     */
    dormitoryInformation: state => state._dormitoryInformation,
...
const actions = {
  /**
    ...
    loadRecords(context, page) {
        return new Promise((resolve, reject) => {
            axios.get('/buildingInformations?page=' + page)
                .then(res =>
                {
    ...
    deleteRecord(context, id) {
        return new Promise((resolve, reject) => {
            ...
            // Try to delete
            axios.delete('/buildingInformations/' + id)
                .then(res => {
