                    ...
                    <div class="card-content">
                        ...
                        <div class="row">
                            ...
                            <div v-if="isRegisterMode">
                                @include('grouppermits.create')
                            </div>
                            <!--  /Register Form  -->

                            <!--  Assign role dialog --}} -->
                            <div v-if="isAssignRole">
                                @include('grouppermits.assign-role')
                            </div>
                            <!--  /Assign role dialog  -->
...
@endsection
@section('scripts')
<script type="text/javascript" src="{{ mix('js/pages/grouppermits/index.js') }}"></script>
@endsection
