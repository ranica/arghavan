                        ...
                        <div class="row">
                            ...
                            <div v-show="isNormalMode">
                                                ...
                                                <td class="text-left" width="160">
                                                    @can('command_delete')
                                                        <a href="#" class="btn btn-round btn-just-icon pull-left"
                                                            data-toggle="modal"
                                                            data-target="#removeRecordModalDegree"
                               ...
                               <card-mobile
                                ...
                                <div class="text-center">
                                    <pagination :data="degrees_paginate"
                                                v-on:pagination-change-page="loadDegrees"
                           ...
                           <!-- Register Form -->
                            <div v-if="isRegisterMode">
                                @include('base-education.degrees.create')
                            </div>
                           <!-- /Register Form -->
