                        ...
                        <div class="row">
                            ...
                            <div v-show="isNormalMode">
                               ...
                               <!-- List Data Table -->
                                <div class="table-responsive col-md-12 pc">
                                    <table id="myTable" class="table table-striped table-hover " v-show="hasFieldRows">
                                                ...
                                                <td class="text-left" width="160">
                                                    @can('command_delete')
                                                        <a href="#" class="btn btn-round btn-just-icon pull-left"
                                                            data-toggle="modal"
                                                            data-target="#removeRecordModalField"
                               ...
                               <card-mobile
                                ...
                                <div class="text-center">
                                    <pagination :data="fields_paginate"
                                                v-on:pagination-change-page="loadFields"
                           ...
                           <!-- Register Form -->
                            <div v-if="isRegisterMode">
                                @include('base-education.fields.create')
                            </div>
                           <!-- /Register Form -->

                            <!-- small modal -->
                            <div class="modal fade" id="removeRecordModalField" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer text-center">
                                            ...
                                            <button type="button" class="btn btn-success btn-simple"  data-dismiss="modal"
                                                @click.prevent="deleteRecord('fields')">بله</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
