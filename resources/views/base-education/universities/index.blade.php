                        ...
                        <div class="row">
                            ...
                            <div v-show="isNormalMode">
                               ...
                               <card-mobile
                                ...
                                <div class="text-center">
                                    <pagination :data="universities_paginate"
                                                v-on:pagination-change-page="loadUniversities"
                           ...
                           <!-- Register Form -->
                            <div v-if="isRegisterMode">
                                @include('base-education.universities.create')
                            </div>
                           <!-- /Register Form -->

                            <!-- small modal -->
                            <div class="modal fade" id="removeRecordModalUniversity" tabindex="-1" role="dialog"
