                       ...
                       <!-- Title -->
                        <h3 class="card-title col-sm-12">
                            <div>
                                ...
                                <span class="panel-heading">نیمسال تحصیلی</span>
                        ...
                        <div class="row">
                            ...
                            <div v-show="isNormalMode">
                               ...
                               <!-- List Data Table -->
                                <div class="table-responsive col-md-12 pc">
                                    <table id="myTable" class="table table-striped table-hover " v-show="hasTermRows">
                                        <thead v-show="!isLoading">
                                            <td width="250">عنوان نیمسال </td>
                                            <td width="250">از تاریخ</td>
                                            <td width="250">تا تاریخ </td>
                                            <td></td>
                                        </thead>
                                        <tbody>
                                            <tr v-if="isLoading">
                                            ...
                                            <tr v-for="record in terms">
                                                <td>@{{ record.semester.name }} @{{ record.year }}</td>
                                                ...
                                                <td class="text-left" width="160">
                                                    @can('command_delete')
                                                        <a href="#" class="btn btn-round btn-just-icon pull-left"
                                                            data-toggle="modal"
                                                            data-target="#removeRecordModalTerm"
                                                    ...
                                                    @can('command_edit')
                                                        <a href="#" class="btn btn-round btn-info btn-just-icon pull-left"
                                                            @click.prevent="editSemesterRecord(record)">
                               ...
                               <term-mobile
                                         v-for="record in terms"
                                         :key= "record.id"
                                         :my-data="record"
                                         @edit-data="editSemesterRecord(record)"
                                         @delete-data="readyToDelete(record)"
                                         title="مشخصات نیمسال">
                                </term-mobile>

                                <div class="text-center">
                                    <pagination :data="terms_paginate"
                                                v-on:pagination-change-page="loadTerms"
                           ...
                           <!-- Register Form -->
                            <div v-if="isRegisterMode">
                                @include('base-education.terms.create')
                            </div>
                           <!-- /Register Form -->

                            <!-- small modal -->
                            <div class="modal fade" id="removeRecordModalTerm" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer text-center">
                                            ...
                                            <button type="button" class="btn btn-success btn-simple"  data-dismiss="modal"
                                                @click.prevent="deleteRecord('terms')">بله</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
