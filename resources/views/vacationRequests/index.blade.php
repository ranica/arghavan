                                    ...
                                    <tbody>
                                        ...
                                        <tr v-for="record in records">
                                            <td>
                                                ...
                                                class="fa fa-hourglass-start  fa-2x text-warning" title="در حال بررسی"></i>
                                            ...
                                            <td>
                                                @can('command_edit')
                                                    <a v-show="record.seen_at == null" href="#" class="btn btn-simple btn-info btn-just-icon pull-left" @click.prevent="editRecord(record)">
                                                ...
                                                {{-- @can('command_delete') --}}
                                                    <a href="#" class="btn btn-simple btn-danger btn-just-icon pull-left" data-toggle="modal" data-target="#removeRecordModal" @click.prevent="readyToDelete(record)">
