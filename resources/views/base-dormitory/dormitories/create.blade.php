    ...
    <div class="card">
        ...
        <div class="card-content f-BYekan">
            <form>
                ...
                <!-- Name field -->
                <div class="form-group label-floating mrg-top-2em" :class="{'has-error' : errors.has('name_dormitorny')}">
                    <label class="control-label">نام خوابگاه</label>
