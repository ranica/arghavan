                       ...
                       <!-- Title -->
                        <h3 class="card-title col-sm-12">
                            <div>
                                ...
                                <span class="panel-heading">استان ها</span>
                        ...
                        <div class="row">
                            ...
                            <div v-show="isNormalMode">
                               ...
                               <!-- List Data Table -->
                                <div class="table-responsive col-md-12 pc">
                                    <table id="myTable" class="table table-striped table-hover " v-show="hasMelliatRows">
                               ...
                               <card-mobile
                                ...
                                <div class="text-center">
                                    <pagination :data="provinces_paginate"
                                                v-on:pagination-change-page="loadProvinces"
                           ...
                           <!-- Register Form -->
                            <div v-if="isRegisterMode">
                                @include('base-structure.provinces.create')
                            </div>
                           <!-- /Register Form -->

                            <!-- small modal -->
                            <div class="modal fade" id="removeRecordModalProvince" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer text-center">
                                            ...
                                            <button type="button" class="btn btn-success btn-simple"  data-dismiss="modal"
                                                @click.prevent="deleteRecord('provinces')">بله</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
