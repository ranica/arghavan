    ...
    <div class="card">
        ...
        <div class="card-content f-BYekan">
            <form>
                ...
                <!-- Name field -->
                <div class="form-group label-floating mrg-top-2em" :class="{'has-error' : errors.has('name_province')}">
                ...
                <span class="pull-left">
                    <input type="submit" value="ذخیره" class="btn btn-fill btn-round btn-rose" @click.prevent="saveProvinceRecord">
