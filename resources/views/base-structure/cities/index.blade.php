                ...
                <div class="row">
                    ...
                    <div v-show="isNormalMode">
                        ...
                        <div class="table-responsive col-md-12 pc">
                            <table id="myTable" class="table table-striped table-hover " v-show="hasCityRows">
                                <thead v-show="!isLoading">
                                    <td width="160">نام استان</td>
                                    <td>نام شهرستان</td>
                                    <td></td>
                                </thead>
                                <tbody>
                                        ...
                                        <td class="text-left" width="160">
                                            ...
                                            @can('command_edit')
                                                <a href="#" class="btn btn-round btn-info btn-just-icon pull-left"
                                                    @click.prevent="editCityRecord(record)">
                        ...
                        <city-mobile
                                    v-for="record in cities"
                                    :key= "record.id"
                                    :my-data="record"
                                    @edit-data="editRecord"
                                    @delete-data="readyToDelete(record)"
                                    title="مشخصات شهرستان">
                        </city-mobile>

                        <div class="text-center">
                            <pagination :data="cities_paginate"
                                        v-on:pagination-change-page="loadCities"
                    ...
                    <div v-show="isRegisterMode">
                        @include('base-structure.cities.create')
                    </div>
                    <!-- /Register Form -->

                    <!-- small modal -->
                    <div class="modal fade" id="removeRecordModalCity" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer text-center">
                                    ...
                                    <button type="button" class="btn btn-success btn-simple"  data-dismiss="modal"
                                        @click.prevent="deleteRecord('cities')">بله</button>
                                </div>
                            </div>
                        </div>
                    </div>
