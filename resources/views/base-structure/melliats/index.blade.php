                        ...
                        <div class="row">
                            ...
                            <div v-show="isNormalMode">
                               ...
                               <card-mobile
                                ...
                                <div class="text-center">
                                    <pagination :data="melliats_paginate"
                                                v-on:pagination-change-page="loadMelliats"
                           ...
                           <!-- Register Form -->
                            <div v-if="isRegisterMode">
                                @include('base-structure.melliats.create')
                            </div>
                           <!-- /Register Form -->

                            <!-- small modal -->
                            <div class="modal fade" id="removeRecordModalMelliat" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer text-center">
                                            ...
                                            <button type="button" class="btn btn-success btn-simple"  data-dismiss="modal"
                                                @click.prevent="deleteRecord('melliats')">بله</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
