                       ...
                       <!-- /Title -->
                        ...
                        <div class="row">
                            ...
                            <div v-show="isNormalMode">
                               ...
                               <!-- List Data Table -->
                                <div class="table-responsive col-md-12 pc">
                                    <table id="myTable" class="table table-striped table-hover " v-show="hasKinTypeRows">
                           ...
                           <!-- /Register Form -->
                            ...
                            <!-- small modal -->
                            <div class="modal fade" id="removeRecordModalKinType" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer text-center">
                                            ...
                                            <button type="button" class="btn btn-success btn-simple"  data-dismiss="modal"
                                                @click.prevent="deleteRecord('kintypes')">بله</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
