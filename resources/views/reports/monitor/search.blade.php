		     	...
		     	{{-- <div class="col-sm-12"> --}}
			     	<h3 class="card-title f-BYekan">
			     		<span class="pull-left">
			     			<input type="submit" value="جستجو" class="btn btn-fill btn-rose" @click.prevent="searchRecord(1)">
		                ...
		                <div class="col-sm-12">
		                	<div class="input-group">
                                ...
                                <div class="form-group label-floating">
                                    ...
                                    <input type="text" class="form-control" v-model="tempRecord.cdn">
                                </div>
                            </div>
		                </div>
		            </div>
