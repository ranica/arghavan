    ...
    <div class="card">
        ...
        <div class="card-content f-BYekan">
            <form>
                ...
                <!-- Name field -->
                <div class="form-group label-floating mrg-top-2em" :class="{'has-error' : errors.has('name_site')}">
                    <label class="control-label">نام پارکینگ</label>
                ...
                <!-- Capacity field -->
                <div class="form-group label-floating mrg-top-2em" :class="{'has-error' : errors.has('capacity_site')}">
                    ...
                    <input autofocus required class="form-control"
                        ...
                        v-validate="{ required: true, is_not:'null' }"
                        data-vv-delay="250"
                        data-vv-as ="ظرفیت پارکینگ" />
                    <span class="material-input"></span>
                </div>
                <!-- /Capacity field -->

                 <!-- State field -->
                <div class = "input-group" :class="{'has-error' :errors.has('state_site')}">
