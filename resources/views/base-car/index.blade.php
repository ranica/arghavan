              ...
              <div class="page-categories">
                ...
                <div class="tab-content tab-space tab-subcategories">
                    <div class="tab-pane active" id="carSite">
                        @include('base-car.site.index')
                    </div>

                   <div class="tab-pane" id="carColor">
                        @include('base-car.color.index')
                    </div>

                    <div class="tab-pane" id="carFuel">
                        @include('base-car.fuel.index')
                    </div>

                    <div class="tab-pane" id="carLevel">
                        @include('base-car.level.index')
                    </div>

                    <div class="tab-pane" id="carModel">
                        @include('base-car.model.index')
                    </div>

                    <div class="tab-pane" id="carSystem">
                        @include('base-car.system.index')
                    </div>

                    <div class="tab-pane" id="carType">
                        @include('base-car.type.index')
                    </div>

                    <div class="tab-pane" id="carPlateType">
                        @include('base-car.plate_type.index')
                    </div>
                </div>
              </div>
            </div>
