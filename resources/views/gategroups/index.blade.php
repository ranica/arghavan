                    ...
                    <div class="card-content">
                        ...
                        <h4 class="card-title">
                            <div>
                                ...
                                <span class="panel-heading"> گرو ه های دسترسی به گیت</span>
                        ...
                        <div class="row">
                                        ...
                                        <tbody>
                                            ...
                                            <tr v-for="record in records">
                                                ...
                                                <td width="160">
                                                    ...
                                                    @can('command_edit')
                                                        <a href="#"
                                                            class="btn btn-round btn-info btn-just-icon pull-left" @click.prevent="editRecord(record)">
                            ...
                            <div v-if="isRegisterMode">
                                @include('gategroups.create')
                            </div>
                            <!--  /Register Form  -->

                            <!--  Assign gatedevice dialog  -->
                            <div v-if="isAssignGatedevice">
                                @include('gategroups.assign-gate-device')
                            </div>
                            <!--  /Assign gatedevice dialog  -->
...
@section('scripts')
<script type="text/javascript" src="{{ mix('js/pages/gategroups/index.js') }}"></script>
@endsection
